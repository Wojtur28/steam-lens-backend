...
public class KafkaConfig {
    ...
    @Bean
    public ProducerFactory<String, SharedLibraryRequestMessage> producerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, SharedLibraryRequestMessage> kafkaTemplate() {
        return new KafkaTemplate<>(producerFactory());
    }

    @Bean
    public ConsumerFactory<String, SharedLibraryRequestMessage> consumerFactory() {
        Map<String, Object> configProps = new HashMap<>();
        ...
        return new DefaultKafkaConsumerFactory<>(
                ...
                new JsonDeserializer<>(SharedLibraryRequestMessage.class)
        );
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, SharedLibraryRequestMessage> kafkaListenerContainerFactory() {
